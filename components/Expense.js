...
const Expense = () => {
  ...
  return (
    <Main className=" h-full  min-w-[800px] bg-[#272c4a] flex flex-row justify-center items-center p-6 rounded-lg">
      <form className="flex">
        <div>
        ...
        <div>
        <div className="flex flex-col m-2">
          <label className="text-[#ea580c] text-xl" >Description</label>
          <textarea onChange={inputEvent} name="bprice" value={data.bprice} type="text" className="num rounded-md text-gray-500  px-4 py-2 mt-2 outline-none  w-full border-2 border-gray-400 appearance-none" placeholder="purpose of expense" />
        </div>
